...
console.log(JSON.stringify({ schemaVersion: 'velmere.r7.audit-basic-zero-vercel-app-route-candidate.v5', status: 'PASS_PATCH_APPLIED', changed, customerFinalCredit: false }, null, 2));
