...
# fetchWithProviderPolicy resolves the allowed Supabase origin from this public URL.
# No service-role key is supplied to the application; the customer route still uses
# the capability-bound Edge bridge and stays fail-closed.
$env:SUPABASE_URL = 'https://yljjyowcvjgjcamffnvd.supabase.co'
