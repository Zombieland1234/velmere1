...
PARENT={
 'fileCount':1601,
 'payloadBytes':21035262,
 'pathSetSha256':'40b966b3bc2497a1d1d18b967ec867f182f76030af23d15329e42c6057268d59',
 'sourceContentAggregateSha256':'c53dcbc3b106f3f686ea392c6188afd3b189fbf1834d6fcb8ce102821d58acca',
}
EXPECTED={
 'fileCount':1601,
...
BEFORE_BYTES=18521
BEFORE_SHA='01aafcb3c8beaf5e53f941f7e89490b3dda7eba86cbe36f5d0c0df2ef092877f'
AFTER_BYTES=18626
AFTER_SHA='b4d8fa17062f559e8933969b9a1d0819213e6ea4d912aabed92481931b1da627'
...
ap=argparse.ArgumentParser(); ap.add_argument('--source-root',required=True); ap.add_argument('--parent-manifest',required=True); ap.add_argument('--manifest',required=True); ap.add_argument('--receipt',required=True); a=ap.parse_args()
root=Path(a.source_root); m=json.loads(Path(a.parent_manifest).read_text(encoding='utf-8'))
