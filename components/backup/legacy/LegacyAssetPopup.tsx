/**
 * VELMERE LEGACY ASSET DETAIL POPUP MODAL (BACKUP / ROLLBACK ONLY)
 * 
 * RETENTION POLICY:
 * This component preserves the legacy modal popup interaction model for emergency rollback.
 * It is intentionally isolated and NOT imported by active production routes.
 * 
 * ROLLBACK PROCEDURE:
 * To restore legacy modal behavior in Shield / Real Markets:
 * 1. Re-import LegacyAssetPopup in:
 ...
 * 2. Restore local state "selected" on row click handlers.
 * 3. Render <LegacyAssetPopup data={...} onClose={() => setSelected(null)} />
 */
