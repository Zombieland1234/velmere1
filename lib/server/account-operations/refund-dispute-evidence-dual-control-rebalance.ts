...
export function GET(request: Request) {
  ...
  const selectedGuard = pass2554.refundDisputeReleaseGuards.find((item) => !requestedSupportCaseId || item.supportCaseId === requestedSupportCaseId) ?? pass2554.refundDisputeReleaseGuards[0];

  return NextResponse.json({
    ok: selectedGuard?.refundDisputeReleaseAllowed ?? false,
    pass: "2554",
    selectedGuard,
    refundDisputeEvidenceDualControlRebalance: pass2554,
    customerSafeRefundDisputeEvidencePacks: pass2554.customerSafeRefundDisputeEvidencePacks,
    supportSlaReviewLanes: pass2554.supportSlaReviewLanes,
    operatorDisputeDualControls: pass2554.operatorDisputeDualControls,
    angelSupportBoundaries: pass2554.angelSupportBoundaries,
    refundDisputeReleaseGuards: pass2554.refundDisputeReleaseGuards,
    previousPassStreamCloseRule: pass2553.releaseEquation,
    releaseEquation: pass2554.releaseEquation,
