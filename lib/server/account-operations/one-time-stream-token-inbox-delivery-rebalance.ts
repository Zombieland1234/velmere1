...
export async function GET(request: Request) {
  ...
  const query = url.searchParams.get("query") || url.searchParams.get("symbol") || "VELMERE_ONE_TIME_STREAM_TOKEN_INBOX_DELIVERY";
  ...
  return NextResponse.json({
    ok: true,
    pass: "2548",
    oneTimeStreamTokenInboxDeliveryRebalance: pass2548,
    tokenRecords: pass2548.tokenRecords,
    downloadStreamTokenGuards: pass2548.downloadStreamTokenGuards,
    angelStreamTokenBoundaries: pass2548.angelStreamTokenBoundaries,
    fixtures: pass2548.fixtures,
    rule: pass2548.oneTimeStreamTokenRule,
  });
}
