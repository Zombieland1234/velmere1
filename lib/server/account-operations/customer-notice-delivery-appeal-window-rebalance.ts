...
export async function GET(request: Request) {
  ...
  const query = url.searchParams.get("query") || url.searchParams.get("symbol") || "VELMERE_CUSTOMER_NOTICE_DELIVERY_APPEAL_WINDOW";
  ...
  return NextResponse.json({
    ok: true,
    pass: "2547",
    customerNoticeDeliveryAppealWindowRebalance: pass2547,
    noticeRecords: pass2547.noticeRecords,
    downloadNoticeGuards: pass2547.downloadNoticeGuards,
    angelNoticeBoundaries: pass2547.angelNoticeBoundaries,
    fixtures: pass2547.fixtures,
    rule: pass2547.customerNoticeDeliveryRule,
  });
}
