...
export function GET(request: Request) {
  ...
  const selectedGuard = pass2552.supportCtaGuards.find((item) => !requestedSupportCaseId || item.supportCaseId === requestedSupportCaseId) ?? pass2552.supportCtaGuards[0];

  return NextResponse.json({
    ok: true,
    pass: "2552",
    selectedGuard,
    mobileAccountVaultResendReviewPanelRebalance: pass2552,
    mobilePanels: pass2552.mobilePanels,
    durableQueueEvents: pass2552.durableQueueEvents,
    privacyVelocityCounters: pass2552.privacyVelocityCounters,
    refundResendCopyParity: pass2552.refundResendCopyParity,
    supportCtaGuards: pass2552.supportCtaGuards,
    releaseEquation: pass2552.releaseEquation,
