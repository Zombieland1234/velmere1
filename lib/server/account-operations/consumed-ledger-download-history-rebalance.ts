...
export async function GET(request: Request) {
  ...
  const query = url.searchParams.get("query") || "VELMERE_CONSUMED_LEDGER_DOWNLOAD_HISTORY";
  ...
  return NextResponse.json({
    ok: true,
    pass: "2550",
    consumedLedgerDownloadHistoryRebalance: pass2550,
    consumedLedgerRecords: pass2550.consumedLedgerRecords,
    finalConsumedDownloadGuards: pass2550.finalConsumedDownloadGuards,
    angelDownloadCompletionBoundaries: pass2550.angelDownloadCompletionBoundaries,
    replayVelocityEvents: pass2550.replayVelocityEvents,
    fixtures: pass2550.fixtures,
    rule: pass2550.consumedLedgerRule,
  });
}
