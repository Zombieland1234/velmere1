...
export function GET(request: Request) {
  ...
  const selectedGuard = pass2553.downloadStreamReleaseGuards.find((item) => !requestedSupportCaseId || item.supportCaseId === requestedSupportCaseId) ?? pass2553.downloadStreamReleaseGuards[0];

  return NextResponse.json({
    ok: selectedGuard?.contentDispositionAllowed ?? false,
    pass: "2553",
    selectedGuard,
    streamCloseResendPersistenceRebalance: pass2553,
    streamCloseHooks: pass2553.streamCloseHooks,
    resendQueueAdapters: pass2553.resendQueueAdapters,
    refundResendEvidencePacks: pass2553.refundResendEvidencePacks,
    downloadStreamReleaseGuards: pass2553.downloadStreamReleaseGuards,
    releaseEquation: pass2553.releaseEquation,
