...
export async function GET(request: Request) {
  ...
  const query = url.searchParams.get("query") || "VELMERE_RLS_SUPPORT_DASHBOARD_ERASURE_RECONCILIATION";
  ...
  const selectedGuard = pass2558.rlsSupportDashboardReleaseGuards.find((item) => !requestedSupportCaseId || item.supportCaseId === requestedSupportCaseId) ?? pass2558.rlsSupportDashboardReleaseGuards[0];

  return NextResponse.json({
    ok: selectedGuard?.supportDashboardVisible ?? false,
    pass: "2558",
    selectedGuard,
    rlsSupportDashboardErasureReconciliationRebalance: pass2558,
    rlsTableContracts: pass2558.rlsTableContracts,
    supportDashboardFilters: pass2558.supportDashboardFilters,
    providerErasureReconciliations: pass2558.providerErasureReconciliations,
    operatorAuditColumnGuards: pass2558.operatorAuditColumnGuards,
    angelDashboardBoundaries: pass2558.angelDashboardBoundaries,
    rlsSupportDashboardReleaseGuards: pass2558.rlsSupportDashboardReleaseGuards,
    previousPassScheduledWorkerRule: pass2557.releaseEquation,
    releaseEquation: pass2558.releaseEquation,
