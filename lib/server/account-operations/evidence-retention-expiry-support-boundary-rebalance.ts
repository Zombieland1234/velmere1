...
export function GET(request: Request) {
  ...
  const selectedGuard = pass2555.retentionExpiryReleaseGuards.find((item) => !requestedSupportCaseId || item.supportCaseId === requestedSupportCaseId) ?? pass2555.retentionExpiryReleaseGuards[0];

  return NextResponse.json({
    ok: selectedGuard?.evidenceRetentionReleaseAllowed ?? false,
    pass: "2555",
    selectedGuard,
    evidenceRetentionExpirySupportBoundaryRebalance: pass2555,
    retentionExpiryCapsules: pass2555.retentionExpiryCapsules,
    customerRefundDisputeTimelines: pass2555.customerRefundDisputeTimelines,
    operatorRetentionApprovals: pass2555.operatorRetentionApprovals,
    angelSupportStatusBoundaries: pass2555.angelSupportStatusBoundaries,
    retentionExpiryReleaseGuards: pass2555.retentionExpiryReleaseGuards,
    previousPassRefundDisputeRule: pass2554.releaseEquation,
    releaseEquation: pass2555.releaseEquation,
