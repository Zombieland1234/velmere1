...
export async function GET(request: Request) {
  ...
  const query = url.searchParams.get("query") || url.searchParams.get("symbol") || "VELMERE_CUSTOMER_EXPORT_RECALL_ATTESTATION";
  ...
  return NextResponse.json({
    ok: true,
    pass: "2543",
    customerExportRecallAttestationRebalance: pass2543,
    attestations: pass2543.attestations,
    recallLedgerEvents: pass2543.recallLedgerEvents,
    fixtures: pass2543.fixtures,
    rule: pass2543.recallRule,
  });
}
