...
export function GET(request: Request) {
  ...
  return NextResponse.json({
    ok: true,
    pass: "2551",
    supportResendRotationAckRebalance: pass2551,
    supportResendRecords: pass2551.supportResendRecords,
    supportResendGuards: pass2551.supportResendGuards,
    angelSupportResendBoundaries: pass2551.angelSupportResendBoundaries,
    supportQueueEvents: pass2551.supportQueueEvents,
    rule: pass2551.supportResendRule,
  });
}
