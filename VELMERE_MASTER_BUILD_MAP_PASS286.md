...
PASS286 adds a Lens report preview gate for M02. The preview is a redacted, source-linked shell only; binary PDF/download/customer export remain blocked until source freshness, storage, redaction, retention and operator review are aligned.

Tracked movement:
- M02 Lens report preview: 80% → 86%
- M01 Velmère Shield Report: 78% → 80%
- M03 Evidence Note: 62% → 65%
- M05 Redacted payload export: 91% → 93%
- K02 Source freshness registry: 71% → 73%
- K04 Storage adapter contract: 55% → 56%
- K05 Privacy redaction envelope: 93% → 94%
- K07 Retention policy: 36% → 38%

<!-- PASS286 marker: Lens Report Preview Gate + Proof Passport Scroll active. -->
