...
add('semantic:private',F['private-object'].get('authorizedRead') is True and F['private-object'].get('anonymousStatus') in [401,403,404] and all(F['private-object'].get('publicAccessBlock',{}).values()))
