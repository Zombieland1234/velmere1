...
console.log(JSON.stringify({schemaVersion:"velmere.pass36.a102r44p9.customer-truth-normalizer.v1",checks:rows.length,passed:rows.length-failed.length,failed:failed.length,rows},null,2));
