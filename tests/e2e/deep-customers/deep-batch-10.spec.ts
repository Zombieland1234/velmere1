...
test.describe("DEEP Observed Customer Validation — Batch 10 (Customers 91 to 100)", () => {
  test("Batch 10 journeys execute with verified DOM state and fail-closed security", async () => {
    ...
    const batchPersonas = receipt.personas.slice(90, 100);
