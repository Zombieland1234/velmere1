...
test.describe("DEEP Observed Customer Validation — Batch 07 (Customers 61 to 70)", () => {
  test("Batch 07 journeys execute with verified DOM state and fail-closed security", async () => {
    ...
    const batchPersonas = receipt.personas.slice(60, 70);
