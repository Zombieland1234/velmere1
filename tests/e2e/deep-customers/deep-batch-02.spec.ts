...
test.describe("DEEP Observed Customer Validation — Batch 02 (Customers 11 to 20)", () => {
  test("Batch 02 journeys execute with verified DOM state and fail-closed security", async () => {
    ...
    const batchPersonas = receipt.personas.slice(10, 20);
