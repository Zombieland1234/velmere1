...
test.describe("DEEP Observed Customer Validation — Batch 03 (Customers 21 to 30)", () => {
  test("Batch 03 journeys execute with verified DOM state and fail-closed security", async () => {
    ...
    const batchPersonas = receipt.personas.slice(20, 30);
