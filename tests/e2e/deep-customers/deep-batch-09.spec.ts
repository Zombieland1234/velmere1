...
test.describe("DEEP Observed Customer Validation — Batch 09 (Customers 81 to 90)", () => {
  test("Batch 09 journeys execute with verified DOM state and fail-closed security", async () => {
    ...
    const batchPersonas = receipt.personas.slice(80, 90);
