...
test.describe("DEEP Observed Customer Validation — Batch 08 (Customers 71 to 80)", () => {
  test("Batch 08 journeys execute with verified DOM state and fail-closed security", async () => {
    ...
    const batchPersonas = receipt.personas.slice(70, 80);
