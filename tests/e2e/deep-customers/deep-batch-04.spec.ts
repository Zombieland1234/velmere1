...
test.describe("DEEP Observed Customer Validation — Batch 04 (Customers 31 to 40)", () => {
  test("Batch 04 journeys execute with verified DOM state and fail-closed security", async () => {
    ...
    const batchPersonas = receipt.personas.slice(30, 40);
