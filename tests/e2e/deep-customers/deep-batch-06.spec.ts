...
test.describe("DEEP Observed Customer Validation — Batch 06 (Customers 51 to 60)", () => {
  test("Batch 06 journeys execute with verified DOM state and fail-closed security", async () => {
    ...
    const batchPersonas = receipt.personas.slice(50, 60);
