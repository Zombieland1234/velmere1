...
SCOPE_REL='artifacts/closure/p99r1/P99R1_PACKAGE_MANIFEST_SCOPE.json'
FIXED='2026-08-21T15:10:00.000Z'
def sha(p:Path)->str:
 h=hashlib.sha256()
 with p.open('rb') as f:
