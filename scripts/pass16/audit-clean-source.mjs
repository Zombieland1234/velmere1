...
const outputPath = outputIndex >= 0 ? process.argv[outputIndex + 1] : ".velmere/pass16-diagnostics/clean-source-audit.json";
...
const audit = {
  schemaVersion: "velmere.pass16.clean-source-audit.v1",
