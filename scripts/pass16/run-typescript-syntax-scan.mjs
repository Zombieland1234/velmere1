...
const result = {
  schemaVersion: "velmere.pass16.typescript-syntax-scan.v1",
...
fs.writeFileSync(path.join(root, "config/pass16/typescript-syntax-scan.json"), `${JSON.stringify(result, null, 2)}\n`, "utf8");
