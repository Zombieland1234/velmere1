...
const required=["PASS238 marker", "pass242"];
...
if (!pkg.includes("verify:pass238-ai-brain")) errors.push("package.json missing pass238 verify script");
