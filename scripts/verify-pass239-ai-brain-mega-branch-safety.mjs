...
const required=["PASS239 marker", "pass242"];
...
if (!pkg.includes("verify:pass239-ai-brain")) errors.push("package.json missing pass239 verify script");
