...
SCOPE_REL = "artifacts/closure/p96r1/P96R1_PACKAGE_MANIFEST_SCOPE.json"
FIXED = "2026-08-21T05:15:00.000Z"
...
scope = {
    "schemaVersion": "velmere.p96r1.package-manifest-scope.v1",
    "generatedAt": FIXED,
    "status": "PASS",
    ...
    "siblingPackagesInsideZip": False,
    "frozenSiblingReceiptsInsideZip": True,
}
...
payload = {
    "schemaVersion": "velmere.p96r1.tree-identity-excluding-self.v1",
    "generatedAt": FIXED,
    "status": "PASS",
    ...
    **identity_projection,
    ...
    "truthBoundary": "Canonical identity of every P96 SOURCE_ONLY file except this self-referential identity receipt. The finalized package manifest is included in this identity and excludes only itself and the identity file.",
}
