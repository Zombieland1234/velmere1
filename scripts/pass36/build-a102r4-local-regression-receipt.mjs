...
import { REV, PARENT, RECEIPT } from "./a102r4-source-boundary.mjs";
...
for (const row of rows) {
  ...
  if (row.checks) passed &&= parsed?.checks===row.checks && parsed?.failed===0;
...
const receipt={
  schemaVersion:"velmere.pass36.a102r4.local-regression-receipt.v1",
  revisionId:REV,
  parentRevisionId:PARENT,
  generatedAt:"2026-07-29T18:54:00.000Z",
  phase:"FINAL",
  status:failed.length?"FAIL_A102R4_LOCAL_REGRESSION":"PASS_A102R4_LOCAL_REGRESSION_ACTION_REQUIRED_NO_PROMOTION",
  summary:{ executedPassRows:results.length, passedRows:results.length-failed.length, failedRows:failed.length, environmentBlockedRows:3 },
  results,
  environmentBlockers:[
  ...
  keyDenominators:{ a102r4AuthChecks:21, a73Checks:57, a73VerifierChecks:73, a89Checks:54, a89Cases:192, a89MutationsKilled:768, apiBodyChecks:37, malformedJsonChecks:112, mega4800Checks:61, a59Checks:77, routeDispatchChecks:1480, routeRoutes:160, lazyRouteChecks:176, productTierChecks:186, zeroBudgetChecks:439 },
