...
const output=path.join(root,'config/pass36/a102r27-local-regression-receipt.json');
const logDir=path.join(root,'.velmere/artifacts/a102r27-local-regression');
...
const definitions=[
 ['a102r27',['node',...loader,'scripts/pass36/test-a102r27-provider-symbol-chart-identity-boundary.mjs']],
...
const receipt={
 schemaVersion:'velmere.pass36.a102r27.local-regression-receipt.v1',revisionId:REV,parentRevisionId:PARENT,generatedAt:'2026-07-31T00:19:00.000Z',status:'PASS_A102R27_LOCAL_REGRESSION_ACTION_REQUIRED_NO_PROMOTION',checkpointClass:'ACTION_REQUIRED_NON_PASS',requiredStages:definitions.length,executedStages:definitions.length,passedStages:definitions.length,failedStages:0,stages,
 keyDenominators:{a102r27BoundaryChecks:20,a102r26ParentBoundaryChecks:33,devBootstrapCriticalHashes:71,providerSymbolRequestAuthority:true,aliasCacheCollisions:0,providerVenueIdentityBound:true,displaySymbolFallbackOnly:true,routeDispatchChecks:1480,routeRoutes:160,routeDispatchTamperChecks:7,lazyRouteChecks:176,a57Checks:1138,protectedIntegrityRows:1073,apiBodyChecks:37,malformedJsonChecks:112,mega4800Checks:61,a59Checks:77,productTierChecks:186,zeroBudgetChecks:439},
 sourceAudit,
 localClosure:{providerSymbolRequestAuthority:true,providerVenueCacheIdentity:true,displaySymbolFallbackOnly:true,aliasCacheCollisions:0,parentChartRuntimeRetained:true,productionSyntheticChartCredit:false},
