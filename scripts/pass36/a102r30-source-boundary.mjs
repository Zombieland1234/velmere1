...
export const REV = 'VELMERE_PASS36_A102R30_ACTION_REQUIRED_CHART_PROVIDER_CADENCE_CANONICAL_SESSION_AND_EVIDENCE_STATE_TRUTH_RECOVERY_NO_REAL_CREDIT';
export const PARENT = 'VELMERE_PASS36_A102R29_ACTION_REQUIRED_CANONICAL_ASSET_CLASS_LOCALE_INDEPENDENT_CHART_ROUTE_CACHE_AND_NESTED_AUTHORITY_PROGRAM_DRIFT_RECOVERY_NO_REAL_CREDIT';
export const MANIFEST = 'config/pass36/a102r30-current-root-descendant-manifest.json';
export const PARENT_MANIFEST = 'config/pass36/a102r29-current-root-descendant-manifest.json';
export const STATE = 'config/pass36/a102r30-action-required-current-state.json';
export const PROGRAM = 'config/pass36/a102r30-world-class-completion-program.json';
export const RECEIPT = 'config/pass36/a102r30-local-regression-receipt.json';
