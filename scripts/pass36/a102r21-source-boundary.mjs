...
export const REV = "VELMERE_PASS36_A102R21_ACTION_REQUIRED_CUSTOMER_ACCESSIBILITY_AND_OPERATOR_CHECKPOINT_JARGON_MINIMALISM_BOUNDARY_NO_REAL_CREDIT";
export const PARENT = "VELMERE_PASS36_A102R20_ACTION_REQUIRED_SINGLE_CURRENT_AUTHORITY_README_HISTORY_LABEL_STALE_POINTER_AND_PLANNING_ESTIMATE_COHERENCE_MINIMALISM_NO_REAL_CREDIT";
export const MANIFEST = "config/pass36/a102r21-current-root-descendant-manifest.json";
export const PARENT_MANIFEST = "config/pass36/a102r20-current-root-descendant-manifest.json";
export const STATE = "config/pass36/a102r21-action-required-current-state.json";
export const PROGRAM = "config/pass36/a102r21-world-class-completion-program.json";
export const RECEIPT = "config/pass36/a102r21-local-regression-receipt.json";
