...
export const STATE =
  "config/pass36/a102r10-action-required-current-state.json";
export const PROGRAM =
  "config/pass36/a102r10-world-class-completion-program.json";
export const RECEIPT =
  "config/pass36/a102r10-local-regression-receipt.json";
