...
const ledger=JSON.parse(fs.readFileSync(path.join(root,'config/pass36/a102r26-approved-chart-runtime-changes.json'),'utf8'));
...
console.log(JSON.stringify({status:'PASS_A102R26_APPROVED_CHART_RUNTIME_CHANGES_NO_PROMOTION',checksPassed:checks,checksFailed:0,fileCount:ledger.fileCount},null,2));
