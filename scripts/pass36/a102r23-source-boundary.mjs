...
export const REV = 'VELMERE_PASS36_A102R23_ACTION_REQUIRED_KLINE_MODE_LOCAL_REFERENCE_DETAIL_ICON_REQUEST_AND_DEV_PREFETCH_STORM_RECOVERY_NO_REAL_CREDIT';
export const PARENT = 'VELMERE_PASS36_A102R22_ACTION_REQUIRED_LOCAL_DEV_RUNTIME_DATA_REFERENCE_ICON_AND_CONTINUOUS_ROUTE_TRANSITION_RECOVERY_NO_REAL_CREDIT';
export const MANIFEST = 'config/pass36/a102r23-current-root-descendant-manifest.json';
export const PARENT_MANIFEST = 'config/pass36/a102r22-current-root-descendant-manifest.json';
export const STATE = 'config/pass36/a102r23-action-required-current-state.json';
export const PROGRAM = 'config/pass36/a102r23-world-class-completion-program.json';
export const RECEIPT = 'config/pass36/a102r23-local-regression-receipt.json';
