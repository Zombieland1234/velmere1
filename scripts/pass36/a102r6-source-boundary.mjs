...
export const PARENT_MANIFEST =
  "config/pass36/a102r5-current-root-descendant-manifest.json";
export const STATE =
  "config/pass36/a102r6-action-required-current-state.json";
export const PROGRAM =
  "config/pass36/a102r6-world-class-completion-program.json";
export const RECEIPT =
  "config/pass36/a102r6-local-regression-receipt.json";
