...
export const PARENT_MANIFEST =
  "config/pass36/a102r4-current-root-descendant-manifest.json";
export const STATE =
  "config/pass36/a102r5-action-required-current-state.json";
export const PROGRAM =
  "config/pass36/a102r5-world-class-completion-program.json";
export const RECEIPT =
  "config/pass36/a102r5-local-regression-receipt.json";
