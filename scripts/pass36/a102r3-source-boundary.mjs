...
export const STATE =
  "config/pass36/a102r3-action-required-current-state.json";
export const PROGRAM =
  "config/pass36/a102r3-world-class-completion-program.json";
export const RECEIPT =
  "config/pass36/a102r3-local-regression-receipt.json";
