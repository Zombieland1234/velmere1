...
const ledger=JSON.parse(fs.readFileSync(path.join(root,'config/pass36/a102r28-approved-chart-race-changes.json'),'utf8'));
...
console.log(JSON.stringify({status:'PASS_A102R28_APPROVED_CHART_RACE_CHANGES_NO_PROMOTION',checksPassed:checks,checksFailed:0,fileCount:ledger.fileCount},null,2));
