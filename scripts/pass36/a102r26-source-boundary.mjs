...
export const REV = 'VELMERE_PASS36_A102R26_ACTION_REQUIRED_ASSET_DETAIL_CHART_SHARED_CACHE_INFLIGHT_RACE_REFERENCE_REFRESH_AND_NO_FLICKER_RECOVERY_NO_REAL_CREDIT';
export const PARENT = 'VELMERE_PASS36_A102R25_ACTION_REQUIRED_LOCAL_REFERENCE_MARKET_INTELLIGENCE_SHORT_CIRCUIT_WITHHELD_BACKOFF_AND_RETRY_TRUTH_NO_REAL_CREDIT';
export const MANIFEST = 'config/pass36/a102r26-current-root-descendant-manifest.json';
export const PARENT_MANIFEST = 'config/pass36/a102r25-current-root-descendant-manifest.json';
export const STATE = 'config/pass36/a102r26-action-required-current-state.json';
export const PROGRAM = 'config/pass36/a102r26-world-class-completion-program.json';
export const RECEIPT = 'config/pass36/a102r26-local-regression-receipt.json';
