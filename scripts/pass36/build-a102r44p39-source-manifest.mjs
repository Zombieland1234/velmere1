...
const manifest = {
  schemaVersion: "velmere.pass36.a102r44p39.source-manifest.v1",
  revisionId: REV,
...
console.log(JSON.stringify({ status: "BUILT_R44P39_SOURCE_MANIFEST", manifestPath: manifestRelative, fileCount: manifest.fileCount, payloadBytes: manifest.payloadBytes, sourceAggregateSha256, pathSetSha256 }, null, 2));
