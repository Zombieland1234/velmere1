...
export const REV="VELMERE_PASS36_A102R44P45_ACTION_REQUIRED_CONTINUOUS_CURRENT_STATE_CONTEXT_QUALIFIED_INTERACTION_ORDERING_PUBLIC_CONTROL_DELTA_NO_LIVE_CREDIT";
export const PARENT="VELMERE_PASS36_A102R44P44_ACTION_REQUIRED_BRUTAL_PRODUCT_REALITY_50_CONTRACT_ANGEL120_PERSONA100_FULL_QA_TEST_CYCLE_3_OF_3_NO_LIVE_CREDIT";
export const MANIFEST="_velmere/PASS36_A102R44P45_SOURCE_ONLY_MANIFEST.json";
export const LEDGER="config/pass36/r44p45-approved-source-changes.json";
export const compareUtf8=(a,b)=>Buffer.compare(Buffer.from(a,"utf8"),Buffer.from(b,"utf8"));
export const sha256=(bytes)=>crypto.createHash("sha256").update(bytes).digest("hex");
export const excludedParts=new Set(["node_modules",".git",".next",".velmere",".turbo",".cache","coverage","test-results","playwright-report","__pycache__",".pytest_cache","tmp","temp","out","cache","failures","artifacts"]);
...
export function pathSet(rows){return sha256(Buffer.from(`${rows.map((row)=>row.path).join("\n")}\n`,"utf8"));}
