...
export const REV = 'VELMERE_PASS36_A102R28_ACTION_REQUIRED_ASSET_DETAIL_ABORTED_INFLIGHT_REOPEN_AND_DEFERRED_IDENTITY_RESET_RACE_RECOVERY_NO_REAL_CREDIT';
export const PARENT = 'VELMERE_PASS36_A102R27_ACTION_REQUIRED_ASSET_DETAIL_PROVIDER_SYMBOL_VENUE_CACHE_AND_REQUEST_IDENTITY_COLLISION_RECOVERY_NO_REAL_CREDIT';
export const MANIFEST = 'config/pass36/a102r28-current-root-descendant-manifest.json';
export const PARENT_MANIFEST = 'config/pass36/a102r27-current-root-descendant-manifest.json';
export const STATE = 'config/pass36/a102r28-action-required-current-state.json';
export const PROGRAM = 'config/pass36/a102r28-world-class-completion-program.json';
export const RECEIPT = 'config/pass36/a102r28-local-regression-receipt.json';
