...
def main() -> int:
    ...
    if args.sample_dir:
        ...
        samples = []
    receipt = {
        "schemaVersion": "velmere.pass36.a102r44p8.audit-pdf-corpus-verification.v1",
        "status": "PASS_A102R44P8_ADVANCED_EVIDENCE_PDF_CORPUS_NO_REAL_CUSTOMER_CREDIT" if not failures else "FAIL_A102R44P8_ADVANCED_EVIDENCE_PDF_CORPUS",
        ...
        "rows": rows,
        "truthBoundary": "This verifies local deterministic R44P8 Basic/Pro/Advanced PDF files, active-content safety, and Advanced-only evidence markers. It is not independent adjudication, browser delivery, real customer comprehension, willingness-to-pay, staging, LIVE or paid-release proof.",
    }
