...
export const REV = 'VELMERE_PASS36_A102R22_ACTION_REQUIRED_LOCAL_DEV_RUNTIME_DATA_REFERENCE_ICON_AND_CONTINUOUS_ROUTE_TRANSITION_RECOVERY_NO_REAL_CREDIT';
export const PARENT = 'VELMERE_PASS36_A102R21_ACTION_REQUIRED_CUSTOMER_ACCESSIBILITY_AND_OPERATOR_CHECKPOINT_JARGON_MINIMALISM_BOUNDARY_NO_REAL_CREDIT';
export const MANIFEST = 'config/pass36/a102r22-current-root-descendant-manifest.json';
export const PARENT_MANIFEST = 'config/pass36/a102r21-current-root-descendant-manifest.json';
export const STATE = 'config/pass36/a102r22-action-required-current-state.json';
export const PROGRAM = 'config/pass36/a102r22-world-class-completion-program.json';
export const RECEIPT = 'config/pass36/a102r22-local-regression-receipt.json';
