...
import { REV, PARENT, RECEIPT } from "./a102r6-source-boundary.mjs";
...
const rows = [
  { id: "a102r6_private_account_browser_state", command: [node, ...loader, "scripts/pass36/test-a102r6-private-account-browser-state-boundary.ts"], expected: "PASS_A102R6_PRIVATE_ACCOUNT_EPHEMERAL_SERVER_CONFIRMED_BOUNDARY_NO_PROMOTION", assertions: 30 },
...
const receipt={
  schemaVersion:"velmere.pass36.a102r6.local-regression-receipt.v1",
  revisionId:REV,
  parentRevisionId:PARENT,
  generatedAt:"2026-07-29T20:56:00.000Z",
  phase:"FINAL",
  status:failed.length?"FAIL_A102R6_LOCAL_REGRESSION":"PASS_A102R6_LOCAL_REGRESSION_ACTION_REQUIRED_NO_PROMOTION",
  ...
  environmentBlockers:[
    ...
    { id:"real_staging_external_inputs", classification:"BLOCKED_EXTERNAL", required:"real two-account durable Account Vault, RLS, IdP/WebAuthn, providers, rights, legal and observers", available:false, credit:false },
  ],
  keyDenominators:{ a102r6PrivateAccountBrowserStateChecks:30, a102r6LegacyPrivateStorageKeysPurged:16, a102r5PaidBoundaryChecks:26, vlmVerifyPositiveCases:1, vlmVerifyNegativeCases:5, a73Checks:57, a73VerifierChecks:73, a89Checks:54, a89VerifierMinimumChecks:156, a89Cases:192, a89MutationsKilled:768, apiBodyChecks:37, malformedJsonChecks:112, mega4800Checks:61, a59Checks:77, routeDispatchChecks:1480, routeDispatchTamperChecks:7, routeRoutes:160, lazyRouteChecks:176, productTierChecks:186, zeroBudgetChecks:439 },
  ...
  realEvidence:{ a102ObservationRuns:0, browserRows:0, stagingStages:0, realDurableAccountVaultRuns:0, providerRights:0, legalDpo:0, customerCohorts:0, independentAssurance:0 },
