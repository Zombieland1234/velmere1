...
export const PARENT_MANIFEST =
  "config/pass36/a102r12-current-root-descendant-manifest.json";
export const STATE =
  "config/pass36/a102r13-action-required-current-state.json";
export const PROGRAM =
  "config/pass36/a102r13-world-class-completion-program.json";
export const RECEIPT =
  "config/pass36/a102r13-local-regression-receipt.json";
