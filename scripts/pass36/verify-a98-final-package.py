...
def main():
    ...
    result={'schemaVersion':'velmere.pass36.a98.final-package-verification.v1','revisionId':REV,'status':'PASS_A98R0_FINAL_PACKAGES_ACTION_REQUIRED_NO_PROMOTION' if not failures else 'FAIL_A98R0_FINAL_PACKAGES','source':source,'materials':materials,'materialsSourceBindingPassed':binding_ok,'failed':len(failures),'failures':failures,'globalDecision':'NO_GO','live':False,'saleEnabled':False,'productionApproved':False,'worldClassProven':False}
