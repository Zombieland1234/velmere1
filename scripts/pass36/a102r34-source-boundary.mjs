...
export const REV = 'VELMERE_PASS36_A102R34_ACTION_REQUIRED_DIALOG_TOP_LAYER_ESCAPE_TAB_OUTSIDE_POINTER_AND_NESTED_RETURN_OWNERSHIP_RECOVERY_NO_REAL_CREDIT';
export const PARENT = 'VELMERE_PASS36_A102R33_ACTION_REQUIRED_DIALOG_FOCUS_RETURN_RAPID_REOPEN_NESTED_MODAL_AND_PENDING_OBSERVER_RACE_RECOVERY_NO_REAL_CREDIT';
export const MANIFEST = 'config/pass36/a102r34-current-root-descendant-manifest.json';
export const PARENT_MANIFEST = 'config/pass36/a102r33-current-root-descendant-manifest.json';
export const STATE = 'config/pass36/a102r34-action-required-current-state.json';
export const PROGRAM = 'config/pass36/a102r34-world-class-completion-program.json';
export const RECEIPT = 'config/pass36/a102r34-local-regression-receipt.json';
