...
export const PARENT_MANIFEST =
  "config/pass36/a102r13-current-root-descendant-manifest.json";
export const STATE =
  "config/pass36/a102r14-action-required-current-state.json";
export const PROGRAM =
  "config/pass36/a102r14-world-class-completion-program.json";
export const RECEIPT =
  "config/pass36/a102r14-local-regression-receipt.json";
