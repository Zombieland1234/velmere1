...
const evidence=JSON.parse(fs.readFileSync("config/pass36/a102r39-a42-critical-rebaseline.json","utf8"));
...
console.log(JSON.stringify({status:"PASS_A102R39_A42_CRITICAL_REBASELINE_76_OF_76_NO_WINDOWS_BROWSER_STAGING_OR_SALE_CREDIT",checksPassed:checks,checksFailed:0,criticalFilesPassed:verified.checks.length,rebaselinedRows:evidence.rebaselinedRowCount},null,2));
