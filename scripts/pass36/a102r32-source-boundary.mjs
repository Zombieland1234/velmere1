...
export const REV = 'VELMERE_PASS36_A102R32_ACTION_REQUIRED_ROUTE_HASH_INVALID_MISSING_TARGET_TIMEOUT_AND_PREFETCH_INTENT_REENTRY_RECOVERY_NO_REAL_CREDIT';
export const PARENT = 'VELMERE_PASS36_A102R31_ACTION_REQUIRED_ROUTE_TRANSITION_HASH_FOCUS_PREFETCH_BOUND_AND_ACCESSIBILITY_CONTINUITY_RECOVERY_NO_REAL_CREDIT';
export const MANIFEST = 'config/pass36/a102r32-current-root-descendant-manifest.json';
export const PARENT_MANIFEST = 'config/pass36/a102r31-current-root-descendant-manifest.json';
export const STATE = 'config/pass36/a102r32-action-required-current-state.json';
export const PROGRAM = 'config/pass36/a102r32-world-class-completion-program.json';
export const RECEIPT = 'config/pass36/a102r32-local-regression-receipt.json';
