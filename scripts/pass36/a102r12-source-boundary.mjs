...
export const STATE =
  "config/pass36/a102r12-action-required-current-state.json";
export const PROGRAM =
  "config/pass36/a102r12-world-class-completion-program.json";
export const RECEIPT =
  "config/pass36/a102r12-local-regression-receipt.json";
