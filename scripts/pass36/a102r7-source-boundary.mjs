...
export const MANIFEST =
  "config/pass36/a102r7-current-root-descendant-manifest.json";
export const PARENT_MANIFEST =
  "config/pass36/a102r6-current-root-descendant-manifest.json";
export const STATE =
  "config/pass36/a102r7-action-required-current-state.json";
export const PROGRAM =
  "config/pass36/a102r7-world-class-completion-program.json";
export const RECEIPT =
  "config/pass36/a102r7-local-regression-receipt.json";
