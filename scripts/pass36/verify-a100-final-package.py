...
def main():
    ...
    result={'schemaVersion':'velmere.pass36.a100.final-package-verification.v1','revisionId':REV,'status':'PASS_A100R0_FINAL_PACKAGES_ACTION_REQUIRED_NO_PROMOTION' if not failures else 'FAIL_A100R0_FINAL_PACKAGES','source':source,'materials':materials,'materialsSourceBindingPassed':binding_ok,'failed':len(failures),'failures':failures,'globalDecision':'NO_GO','live':False,'saleEnabled':False,'productionApproved':False,'worldClassProven':False}
