...
const manifest = {
  schemaVersion: "velmere.pass36.a102r44p37.source-manifest.v1",
  revisionId: REV,
...
process.stdout.write(`${JSON.stringify({ status: "BUILT_R44P37_SOURCE_MANIFEST", manifestPath: manifestRelative, ...manifest, files: undefined }, null, 2)}\n`);
