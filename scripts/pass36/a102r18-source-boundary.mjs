...
export const MANIFEST =
  "config/pass36/a102r18-current-root-descendant-manifest.json";
export const PARENT_MANIFEST =
  "config/pass36/a102r17-current-root-descendant-manifest.json";
export const STATE =
  "config/pass36/a102r18-action-required-current-state.json";
export const PROGRAM =
  "config/pass36/a102r18-world-class-completion-program.json";
export const RECEIPT =
  "config/pass36/a102r18-local-regression-receipt.json";
