...
const revisionId = "VELMERE_PASS36_A102R44P11_ACTION_REQUIRED_COMPILER_AST_FOUNDRY_FUZZ_INVARIANT_ANGEL_SAFETY_UI_RUNTIME_AND_FINAL_BYTE_CLOSURE_NO_LIVE_CREDIT";
const parentRevisionId = "VELMERE_PASS36_A102R44P10_ACTION_REQUIRED_METAMORPHIC_GENERALIZATION_CUSTOMER_CONFIDENCE_AND_ANALYSIS_QUEUE_TRUTH_CLEAN_SOURCE_CLOSURE_NO_LIVE_CREDIT";
...
const document = {
  schemaVersion: "velmere.pass36.a102r44p11.source-manifest.v1",
  revisionId,
  parentRevisionId,
  manifestPath: manifestRel,
  manifestSelfExcluded: true,
  parentSourceArchive: {
    filename: "VELMERE_PASS36_A102R44P10_ACTION_REQUIRED_METAMORPHIC_GENERALIZATION_CUSTOMER_CONFIDENCE_AND_ANALYSIS_QUEUE_TRUTH_CLEAN_SOURCE_CLOSURE_NO_LIVE_CREDIT_SOURCE_ONLY.zip",
    byteLength: 55729848,
    sha256: "224084e6ef16af28a25b09f163f71943d905f1bc2084ed66664d16e222979430",
  },
...
console.log(JSON.stringify({ status: "PASS_R44P11_SOURCE_MANIFEST_BUILT", revisionId, fileCount: document.fileCount, byteLength: document.byteLength, pathSetSha256, aggregateSha256, manifestPath: manifestRel }, null, 2));
