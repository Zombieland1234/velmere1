...
export const STATE =
  "config/pass36/a102r17-action-required-current-state.json";
export const PROGRAM =
  "config/pass36/a102r17-world-class-completion-program.json";
export const RECEIPT =
  "config/pass36/a102r17-local-regression-receipt.json";
