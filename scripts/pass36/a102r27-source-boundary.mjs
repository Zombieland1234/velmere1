...
export const REV = 'VELMERE_PASS36_A102R27_ACTION_REQUIRED_ASSET_DETAIL_PROVIDER_SYMBOL_VENUE_CACHE_AND_REQUEST_IDENTITY_COLLISION_RECOVERY_NO_REAL_CREDIT';
export const PARENT = 'VELMERE_PASS36_A102R26_ACTION_REQUIRED_ASSET_DETAIL_CHART_SHARED_CACHE_INFLIGHT_RACE_REFERENCE_REFRESH_AND_NO_FLICKER_RECOVERY_NO_REAL_CREDIT';
export const MANIFEST = 'config/pass36/a102r27-current-root-descendant-manifest.json';
export const PARENT_MANIFEST = 'config/pass36/a102r26-current-root-descendant-manifest.json';
export const STATE = 'config/pass36/a102r27-action-required-current-state.json';
export const PROGRAM = 'config/pass36/a102r27-world-class-completion-program.json';
export const RECEIPT = 'config/pass36/a102r27-local-regression-receipt.json';
