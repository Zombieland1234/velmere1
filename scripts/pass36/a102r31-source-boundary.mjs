...
export const REV = 'VELMERE_PASS36_A102R31_ACTION_REQUIRED_ROUTE_TRANSITION_HASH_FOCUS_PREFETCH_BOUND_AND_ACCESSIBILITY_CONTINUITY_RECOVERY_NO_REAL_CREDIT';
export const PARENT = 'VELMERE_PASS36_A102R30_ACTION_REQUIRED_CHART_PROVIDER_CADENCE_CANONICAL_SESSION_AND_EVIDENCE_STATE_TRUTH_RECOVERY_NO_REAL_CREDIT';
export const MANIFEST = 'config/pass36/a102r31-current-root-descendant-manifest.json';
export const PARENT_MANIFEST = 'config/pass36/a102r30-current-root-descendant-manifest.json';
export const STATE = 'config/pass36/a102r31-action-required-current-state.json';
export const PROGRAM = 'config/pass36/a102r31-world-class-completion-program.json';
export const RECEIPT = 'config/pass36/a102r31-local-regression-receipt.json';
