...
const policy = JSON.parse(fs.readFileSync(path.join(root, "config/pass15/gate-policy.json"), "utf8"));
...
if (!runner.includes("scripts/pass15/run-gate.mjs")) issues.push("runner_not_bound_to_pass15_gate");
...
const result = {
  schemaVersion: "velmere.pass15.runner-contract.v1",
