...
const required=["PASS240 marker", "pass242"];
...
if (!pkg.includes("verify:pass240-ai-brain")) errors.push("package.json missing pass240 verify script");
