/** Minimal declarations used only for the P83 strict targeted TypeScript diagnostic.
 * They model the imported production contracts exercised by the P83 runtime harness.
