...
const criticalNamespaces = new Set(["Auth", "Account", "Cookie", "Errors", "Home", "Square", "MarketIntegrity", "Angel"]);
const allowlist = JSON.parse(fs.readFileSync(path.join(root, "config/pass20/i18n-neutral-allowlist.json"), "utf8"));
...
const result = {
  schemaVersion: "velmere.pass20.i18n-release-readiness.v1",
...
const out = path.join(root, ".velmere/pass20-diagnostics/i18n-release-readiness.json");
