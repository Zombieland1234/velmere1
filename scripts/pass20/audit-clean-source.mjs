...
const outputPath = outputIndex >= 0 ? process.argv[outputIndex + 1] : ".velmere/pass20-diagnostics/clean-source-audit.json";
...
const audit = {
  schemaVersion: "velmere.pass20.clean-source-audit.v1",
