...
console.log("PASS435 live query test bench · provider reality before PDF/chat\n");
...
console.log("PASS435 invariant: one payload, one locale, no fake-live, missing data visible before PDF/chat.");
