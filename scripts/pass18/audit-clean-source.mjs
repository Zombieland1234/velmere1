...
const outputPath = outputIndex >= 0 ? process.argv[outputIndex + 1] : ".velmere/pass18-diagnostics/clean-source-audit.json";
...
const audit = {
  schemaVersion: "velmere.pass18.clean-source-audit.v1",
