...
const policy = JSON.parse(fs.readFileSync(path.join(root, "config/pass18/gate-policy.json"), "utf8"));
...
if (!runner.includes("scripts/pass18/run-gate.mjs")) issues.push("runner_not_bound_to_pass18_gate");
...
const result = {
  schemaVersion: "velmere.pass18.runner-contract.v1",
