...
const LOG_PATH = "artifacts/pass35/PASS35_A17_NONDESTRUCTIVE_REGRESSION.log";
const RECEIPT_PATH = "artifacts/pass35/PASS35_A17_NONDESTRUCTIVE_REGRESSION_RECEIPT.json";
...
const cases = [
  ...
  node("a17_control_plane", "scripts/pass35/test-a17-control-plane.mjs"),
...
for (const testCase of cases) {
  ...
  console.log(`[A17 regression] ${testCase.id}`);
  const caseOutputPath = `artifacts/pass35/.a17-regression-${testCase.id}.tmp.log`;
...
const receiptCore = {
  schemaVersion: "velmere.pass35.a17-nondestructive-regression-receipt.v1",
  startedAt,
  ...
  truthBoundary: "This runner executes non-mutating current-source runtime, security, market, PDF and A4-A17 regression tests. It does not grant exact Node/npm, staging, LIVE, customer, legal, provider-rights or independent-assurance credit.",
};
