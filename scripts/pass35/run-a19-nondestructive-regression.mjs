...
const LOG_PATH = "artifacts/pass35/PASS35_A19_NONDESTRUCTIVE_REGRESSION.log";
const RECEIPT_PATH = "artifacts/pass35/PASS35_A19_NONDESTRUCTIVE_REGRESSION_RECEIPT.json";
...
const cases = [
  ...
  node("a17_pdf_structure", "scripts/pass35/verify-a17-packet-pdf-corpus.mjs"),
  node("a17_pdf_raster_receipt", "scripts/pass35/verify-a17-packet-pdf-raster-receipt.mjs"),
  ...
  node("a19_control_plane", "scripts/pass35/test-a19-control-plane.mjs"),
...
for (const testCase of cases) {
  ...
  console.log(`[A19 regression] ${testCase.id}`);
  const caseOutputPath = `artifacts/pass35/.a19-regression-${testCase.id}.tmp.log`;
...
const receiptCore = {
  schemaVersion: "velmere.pass35.a19-nondestructive-regression-receipt.v1",
  startedAt,
  ...
  truthBoundary: "This runner executes non-mutating current-source runtime, security, market, PDF and A4-A19 regression tests. It does not grant exact Node/npm, staging, LIVE, customer, legal, provider-rights or independent-assurance credit.",
};
