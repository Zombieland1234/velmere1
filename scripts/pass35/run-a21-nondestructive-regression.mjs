...
const LOG_PATH = "artifacts/pass35/PASS35_A21_NONDESTRUCTIVE_REGRESSION.log";
const RECEIPT_PATH = "artifacts/pass35/PASS35_A21_NONDESTRUCTIVE_REGRESSION_RECEIPT.json";
...
for (const testCase of cases) {
  ...
  console.log(`[A21 regression] ${testCase.id}`);
  const caseOutputPath = `artifacts/pass35/.a21-regression-${testCase.id}.tmp.log`;
...
const receiptCore = {
  schemaVersion: "velmere.pass35.a21-nondestructive-regression-receipt.v1",
  startedAt,
  ...
  truthBoundary: "This runner executes non-mutating current-source runtime, security, market, PDF and A4-A21 regression tests. It does not grant exact Node/npm, staging, LIVE, customer, legal, provider-rights or independent-assurance credit.",
};
