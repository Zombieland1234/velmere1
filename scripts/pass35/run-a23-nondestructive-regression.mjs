...
const LOG_PATH = "artifacts/pass35/PASS35_A23_NONDESTRUCTIVE_REGRESSION.log";
const RECEIPT_PATH = "artifacts/pass35/PASS35_A23_NONDESTRUCTIVE_REGRESSION_RECEIPT.json";
...
for (const testCase of cases) {
  ...
  console.log(`[A23 regression] ${testCase.id}`);
  const caseOutputPath = `artifacts/pass35/.a23-regression-${testCase.id}.tmp.log`;
...
const receiptCore = {
  schemaVersion: "velmere.pass35.a23-nondestructive-regression-receipt.v1",
  startedAt,
  ...
  truthBoundary: "This runner executes non-mutating current-source runtime, security, market, PDF and A4-A23 regression tests. It does not grant exact Node/npm, staging, LIVE, customer, legal, provider-rights or independent-assurance credit.",
};
