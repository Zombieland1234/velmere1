...
const result = {
  schemaVersion: "velmere.pass19.typescript-syntax-scan.v1",
...
fs.writeFileSync(path.join(root, "config/pass19/typescript-syntax-scan.json"), `${JSON.stringify(result, null, 2)}\n`, "utf8");
