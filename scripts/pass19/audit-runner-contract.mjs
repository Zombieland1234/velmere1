...
const policy = JSON.parse(fs.readFileSync(path.join(root, "config/pass19/gate-policy.json"), "utf8"));
...
if (!runner.includes("scripts/pass19/run-gate.mjs")) issues.push("runner_not_bound_to_pass19_gate");
...
const result = {
  schemaVersion: "velmere.pass19.runner-contract.v1",
