...
const outputPath = outputIndex >= 0 ? process.argv[outputIndex + 1] : ".velmere/pass19-diagnostics/clean-source-audit.json";
...
const audit = {
  schemaVersion: "velmere.pass19.clean-source-audit.v1",
