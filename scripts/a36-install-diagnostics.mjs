...
const endpointState = (raw) => {
  ...
  try {
    ...
    const official = parsed.hostname === "registry.npmjs.org";
    return official ? "official_npm_registry" : "configured_custom_registry_redacted";
  } catch {
...
const result = {
  ...
  guidance: [
    ...
    "On Windows run: powershell -ExecutionPolicy Bypass -File .\\VELMERE_SETUP_WINDOWS_A36.ps1",
