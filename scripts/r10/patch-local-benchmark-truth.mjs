...
const replacements = [
  ...
  ["Blind Holdout Integrity: Unseen test set evaluated without parameter leakage.", "Local Holdout Scope: held apart from DEV/VALIDATION inside this repository; no independence or zero-leakage claim."],
