export const DEPLOYMENT_BUILD_COMMANDS = Object.freeze({
  ...
  "build:deployment": "node scripts/verify-runtime-contract.mjs --deployment && node scripts/deployment/preflight.mjs && node scripts/deployment/run-segmented-build.mjs turbopack && node scripts/deployment/verify-segmented-build-lock-boundary.mjs --phase post-build",
});
