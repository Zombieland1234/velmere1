...
import { assertDeploymentRuntime, currentNpmVersion } from "../lib/velmere-runtime-contract.mjs";
...
const npm = currentNpmVersion();
try {
  assertDeploymentRuntime({ nodeVersion: process.version, npmVersion: npm, label: "Segmented build deployment runtime" });
} catch (error) {
