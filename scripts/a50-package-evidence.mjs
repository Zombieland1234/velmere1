...
const source = path.join(root, "artifacts/pass35/a50");
const out = path.join(root, "artifacts/pass35/PASS35_A50_TRANSACTIONAL_EMAIL_PRIVATE_STORAGE_KMS_ACCEPTANCE_EVIDENCE.zip");
...
fs.writeFileSync(path.join(source, "PASS35_A50_EVIDENCE_MANIFEST.json"), `${JSON.stringify({ schemaVersion: "velmere.pass35.a50.evidence-manifest.v1", revisionId: "VELMERE_PASS35_A50_TRANSACTIONAL_EMAIL_PRIVATE_STORAGE_KMS_ACCEPTANCE", generatedAt: new Date().toISOString(), files: manifest }, null, 2)}\n`);
