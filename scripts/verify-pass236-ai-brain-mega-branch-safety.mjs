...
const required=["PASS236 marker", "pass242"];
...
if (!pkg.includes("verify:pass236-ai-brain")) errors.push("package.json missing pass236 verify script");
