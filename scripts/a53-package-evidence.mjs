...
const source = path.join(root, "artifacts/pass35/a53");
const out = path.join(root, "artifacts/pass35/PASS35_A53_MEASURED_SLO_ALERT_ACK_VENDOR_EXIT_ACCEPTANCE_EVIDENCE.zip");
...
fs.writeFileSync(path.join(source, "PASS35_A53_EVIDENCE_MANIFEST.json"), `${JSON.stringify({ schemaVersion: "velmere.pass35.a53.evidence-manifest.v1", revisionId: "VELMERE_PASS35_A53_MEASURED_SLO_ALERT_ACK_VENDOR_EXIT_ACCEPTANCE", generatedAt: new Date().toISOString(), files: manifest }, null, 2)}\n`);
