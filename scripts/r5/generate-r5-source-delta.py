...
ROOT = Path.cwd()
PARENT = Path('/mnt/data/VELMERE_P101R1_V4_AUDITED_CURRENT_SOURCE_CANDIDATE_R4_2026-08-22.zip')
TSV_OUT = ROOT / 'VELMERE_R5_SOURCE_DELTA_FROM_R4.tsv'
JSON_OUT = ROOT / 'artifacts/r5/VELMERE_R5_SOURCE_DELTA_FROM_R4.json'
GENERATED_AT = '2026-08-23T02:30:00.000Z'
EXCLUSIONS = {
    ...
    'VELMERE_R5_SOURCE_DELTA_FROM_R4.tsv',
    'artifacts/r5/VELMERE_R5_SOURCE_DELTA_FROM_R4.json',
}
...
TSV_OUT.write_text('\n'.join(lines) + '\n')
payload = {
    'schemaVersion': 'velmere.r5.source-delta-from-r4.v1',
    ...
    'changes': changes,
    'truthBoundary': 'Byte/path delta from the R4 archive excluding self-referential current manifests/receipts, the delta files themselves and runtime-only .git/.velmere/node_modules paths. It does not prove product FINAL.',
}
