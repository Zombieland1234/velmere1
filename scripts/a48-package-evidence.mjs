...
const source = path.join(root, "artifacts/pass35/a48");
const out = path.join(root, "artifacts/pass35/PASS35_A48_STAGING_TENANT_ISOLATION_EVIDENCE.zip");
...
fs.writeFileSync(path.join(source, "PASS35_A48_EVIDENCE_MANIFEST.json"), `${JSON.stringify({ schemaVersion: "velmere.pass35.a48.evidence-manifest.v1", revisionId: "VELMERE_PASS35_A48_STAGING_TENANT_ISOLATION_ACCEPTANCE", generatedAt: new Date().toISOString(), files: manifest }, null, 2)}\n`, "utf8");
