...
const required=["PASS241 marker", "pass242"];
...
if (!pkg.includes("verify:pass241-ai-brain")) errors.push("package.json missing pass241 verify script");
