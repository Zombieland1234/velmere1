...
const result = {
  schemaVersion: "velmere.pass17.typescript-syntax-scan.v1",
...
if (writeOutput) fs.writeFileSync(path.join(root, "config/pass17/typescript-syntax-scan.json"), `${JSON.stringify(result, null, 2)}\n`, "utf8");
