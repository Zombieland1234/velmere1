...
const policy = JSON.parse(fs.readFileSync(path.join(root, "config/pass17/gate-policy.json"), "utf8"));
...
if (!runner.includes("scripts/pass17/run-gate.mjs")) issues.push("runner_not_bound_to_pass17_gate");
...
const result = {
  schemaVersion: "velmere.pass17.runner-contract.v1",
