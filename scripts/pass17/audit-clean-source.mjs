...
const outputPath = outputIndex >= 0 ? process.argv[outputIndex + 1] : ".velmere/pass17-diagnostics/clean-source-audit.json";
...
const audit = {
  schemaVersion: "velmere.pass17.clean-source-audit.v1",
