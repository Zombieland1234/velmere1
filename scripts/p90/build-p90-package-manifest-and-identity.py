...
SCOPE_REL='artifacts/closure/p90r1/P90R1_PACKAGE_MANIFEST_SCOPE.json'
FIXED='2026-08-20T17:18:00.000Z'
def sha(p:Path):
 h=hashlib.sha256()
 with p.open('rb') as f:
