...
const outputPath = outputIndex >= 0 ? process.argv[outputIndex + 1] : ".velmere/pass21-diagnostics/clean-source-audit.json";
...
const audit = {
  schemaVersion: "velmere.pass21.clean-source-audit.v1",
