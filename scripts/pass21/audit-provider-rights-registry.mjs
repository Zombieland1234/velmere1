...
import { verifyEvidenceFile } from "../r13g/verify-evidence-file.mjs";
...
for(const p of registry.providers??[]){
 ...
 for(const e of evidence) for(const issue of verifyEvidenceFile(root,e)) errors.push(`${issue}:${p.id}`);
}
