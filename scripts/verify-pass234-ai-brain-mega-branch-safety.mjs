...
const required=["PASS234 marker", "pass242"];
...
if (!pkg.includes("verify:pass234-ai-brain")) errors.push("package.json missing pass234 verify script");
