...
const required=["PASS233 marker", "pass242"];
...
if (!pkg.includes("verify:pass233-ai-brain")) errors.push("package.json missing pass233 verify script");
