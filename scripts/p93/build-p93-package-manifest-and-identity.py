...
SCOPE_REL = "artifacts/closure/p93r1/P93R1_PACKAGE_MANIFEST_SCOPE.json"
FIXED = "2026-08-20T16:05:00.000Z"
...
if identity.exists():
    identity.unlink()
scope = {
    "schemaVersion": "velmere.p93r1.package-manifest-scope.v1",
    "generatedAt": FIXED,
    "status": "PASS",
...
payload = {
    "schemaVersion": "velmere.p93r1.tree-identity-excluding-self.v1",
    "generatedAt": FIXED,
    "status": "PASS",
