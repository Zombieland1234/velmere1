...
const required=["PASS237 marker", "pass242"];
...
if (!pkg.includes("verify:pass237-ai-brain")) errors.push("package.json missing pass237 verify script");
