...
SCOPE_REL='artifacts/closure/p92r1/P92R1_PACKAGE_MANIFEST_SCOPE.json'
FIXED='2026-08-20T21:05:00.000Z'
def sha(p:Path):
 h=hashlib.sha256()
 with p.open('rb') as f:
