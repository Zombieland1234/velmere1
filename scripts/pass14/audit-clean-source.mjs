...
const outputPath = outputIndex >= 0 ? process.argv[outputIndex + 1] : ".velmere/pass14-diagnostics/clean-source-audit.json";
...
const ignoredPathPrefixes = [
  ".velmere/pass14-gates/",
  ".velmere/pass14-diagnostics/",
  ".velmere/pass14-builds/",
  ".velmere/pass15-gates/",
  ".velmere/pass15-diagnostics/",
  ".velmere/pass15-builds/"
];
...
const audit = {
  schemaVersion: "velmere.pass14.clean-source-audit.v1",
  generatedAt: new Date().toISOString(),
  truthBoundary: "Every regular file outside generated PASS14 local diagnostics and the self-referential CLEAN_SAFE_VERIFICATION.json was byte-read and SHA-256 hashed. Text files were line-counted and scanned with conservative static heuristics. JavaScript-family syntax is verified separately with node --check. This is not semantic TypeScript, ESLint, Next build, browser, staging or LIVE evidence.",
