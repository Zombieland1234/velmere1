...
const policy = JSON.parse(fs.readFileSync(path.join(root, "config/pass14/gate-policy.json"), "utf8"));
...
if (!runner.includes("scripts/pass14/run-gate.mjs")) issues.push("runner_not_bound_to_pass14_gate");
...
const result = {
  schemaVersion: "velmere.pass14.runner-contract.v1",
