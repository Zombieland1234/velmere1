...
const output = outputIndex >= 0 ? process.argv[outputIndex + 1] : "artifacts/pass11/PASS11_OFFLINE_INSTALL_COVERAGE.json";
...
const receipt = {
  schemaVersion: "velmere.pass11.offline-install-coverage.v1",
