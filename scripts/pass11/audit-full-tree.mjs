...
const output = outputIndex >= 0 ? process.argv[outputIndex + 1] : "artifacts/pass11/PASS11_FULL_TREE_AUDIT.json";
const manifestIndex = process.argv.indexOf("--manifest");
const manifestOutput = manifestIndex >= 0 ? process.argv[manifestIndex + 1] : "artifacts/pass11/PASS11_FULL_TREE_MANIFEST.json";
...
const audit = {
  schemaVersion: "velmere.pass11.full-tree-audit.v1",
