...
SCOPE_REL='artifacts/closure/p91r1/P91R1_PACKAGE_MANIFEST_SCOPE.json'
FIXED='2026-08-20T19:30:00.000Z'
def sha(p:Path):
 h=hashlib.sha256()
 with p.open('rb') as f:
