#!/usr/bin/env python3
"""Build the non-circular P38 current-source identity bound to Owner Directive V15.
...
DEFAULT_OUTPUT = ROOT / "artifacts/closure/p38/source-identity.json"
OWNER_DIRECTIVE_V15 = (
    "docs/authority/"
...
def main() -> int:
    ...
    result = {
        "schemaVersion": "velmere.p38.source-identity.v1",
        ...
        "parentSourceAggregateSha256": "cb460d6968d7455057bf319cae25bf1e8b63869d6bdaf15b70c3eed051a31563",
        "fileCount": len(rows),
        ...
        "truthBoundary": (
            "This identity binds P38 source inputs, the exact unmodified V15 owner directive, current-lock CAS recovery source, and Node-major differential tooling. "
            "It excludes generated receipts, dependencies, build/cache trees, physical PDF/Browser corpora, "
            "external fonts and materials. It proves source identity, public-key inclusion policy, and source inclusion of the bounded P38 recovery mechanisms only; "
    ...
    print(json.dumps({
        "status": "PASS_P38_V15_CURRENT_SOURCE_IDENTITY_BUILT",
