...
MANIFEST = ART / "P35_SOURCE_MANIFEST.json"
EXCLUSIONS = ART / "P35_PACKAGE_EXCLUSIONS.json"
...
EXCLUDE_PATTERNS = [
    ...
    "artifacts/closure/p35/internal-ai-dual-ledger-build.stdout.json",
    "artifacts/closure/p35/internal-ai-dual-ledger-verify.stdout.json",
    "artifacts/closure/p35/a102-internal-ai-dual-ledger.stdout.json",
    "artifacts/closure/p35/source-identity-build.stdout.json",
    "artifacts/closure/p35/report-build.stdout.json",
    "artifacts/closure/p35/package.stdout.json",
    "artifacts/closure/p35/P35_SOURCE_MANIFEST.json",
    "artifacts/closure/p35/*.stdout.json",
    "artifacts/closure/p35/p35-transpile-diagnostic.cjs",
    "artifacts/closure/p33/paid-tests-current/**",
]
...
def build_manifest(rows: list[dict[str, object]]) -> dict[str, object]:
    ...
    return {
        "schemaVersion": "velmere.p35.source-only-package-manifest.v1",
        ...
        "entries": rows,
        "truthBoundary": "The embedded manifest excludes itself. SOURCE_ONLY includes current code/configs, methodology, Growth Intel, P35 current AI availability/artifact raw assessment archive and compact receipts. It excludes dependencies, build outputs, repeated raw logs, generated PDF/raster corpora and external QA inputs. 100% internal AI execution and internal eligibility/artifact parity grant zero real-customer/independent-review/legal/provider-rights/GO_PAID/world-class credit.",
    }
...
def main() -> int:
    ...
    EXCLUSIONS.write_text(json.dumps({
        "schemaVersion": "velmere.p35.source-only-package-exclusions.v1",
    ...
    receipt = {
        "schemaVersion": "velmere.p35.deterministic-package-receipt.v1",
        "state": "CURRENT_SOURCE_ONLY_IN_PROGRESS",
        "archive": str(out),
        "copyB": str(copy_b),
        "sha256": sha_a,
