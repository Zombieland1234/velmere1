...
OUT = ROOT / "artifacts/closure/p34/source-identity.json"
...
def main() -> int:
    ...
    result = {
        "schemaVersion": "velmere.p34.source-identity.v1",
        "classification": "CURRENT_SOURCE_INPUT_EXCLUDES_P34_GENERATED_RECEIPTS",
        "fileCount": len(rows),
    ...
    print(json.dumps({
        "status": "PASS_P34_SOURCE_IDENTITY_BUILT",
