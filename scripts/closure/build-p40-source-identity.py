#!/usr/bin/env python3
"""Build the non-circular P40 current-source identity bound to Owner Directive V16.
...
DEFAULT_OUTPUT = ROOT / "artifacts/closure/p40/source-identity.json"
OWNER_DIRECTIVE_V16 = (
    "docs/authority/"
...
def main() -> int:
    ...
    result = {
        "schemaVersion": "velmere.p40.source-identity.v1",
        ...
        "generatedAt": "2026-08-14T06:35:00.000Z",
        "parentRoot": "R44P46",
        "parentCheckpoint": "P39_V16_AUTHORITY_TOPOLOGY_AND_EXACT_NODE24_LINUX_RECONCILIATION",
        "parentSourceAggregateSha256": "f8caeb6d43dcc509d234d58c5e98780babe476755046fc6a92e13e2b44a79968",
        "fileCount": len(rows),
        ...
        "requiredAuthorityBinding": {
            ...
            "replacesV15OnlyAfterCompleteP40Binding": True,
        ...
        "truthBoundary": (
            "This identity binds P40 source inputs, the exact unmodified V16 owner directive, the canonical A85 repair, P40 fixture-profile/right-baseline tooling, and inherited P39 exact-runtime/dependency evidence. "
            "It excludes generated receipts, dependencies, build/cache trees, physical PDF/Browser corpora, "
            "external fonts and materials. It proves source identity, exact V16 inclusion, public-key inclusion policy, and source inclusion of the bounded P40 authority/topology mechanisms only; "
    ...
    print(json.dumps({
        "status": "PASS_P40_V16_CURRENT_SOURCE_IDENTITY_BUILT",
