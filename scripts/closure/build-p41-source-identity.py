#!/usr/bin/env python3
"""Build the non-circular P41 current-source identity bound to Owner Directive V16.
...
DEFAULT_OUTPUT = ROOT / "artifacts/closure/p41/source-identity.json"
...
EXCLUDED_ROOT_DIRECTORIES = {"artifacts", "coverage", "temp", "tmp", "p41-out"}
EXCLUDED_PREFIXES = (
    "artifacts/closure",
...
def main() -> int:
    ...
    result = {
        "schemaVersion": "velmere.p41.source-identity.v1",
        ...
        "parentRoot": "R44P46",
        "parentCheckpoint": "P40_V16_A85_CANONICAL_REPLAY_SOURCE_DIFFERENTIAL_FIXTURE_PROFILE_BASELINE",
        "parentSourceAggregateSha256": P40_SOURCE_AGG,
        "fileCount": len(rows),
        ...
        "truthBoundary": (
            "This identity binds the P41 current-root Windows bridge repair, exact unmodified V16, package.json, "
            "package-lock.json and source bytes. It excludes generated receipts, dependencies, builds, physical PDF/Browser "
            "corpora, external fonts and MATERIALS. It does not prove a successful exact-Windows current-root install, "
    ...
    print(json.dumps({
        "status": "PASS_P41_V16_CURRENT_SOURCE_IDENTITY_BUILT",
